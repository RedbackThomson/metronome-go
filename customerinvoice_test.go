...
func TestCustomerInvoiceGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.Customers.Invoices.Get(context.TODO(), metronome.CustomerInvoiceGetParams{
...
func TestCustomerInvoiceListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Customers.Invoices.List(context.TODO(), metronome.CustomerInvoiceListParams{
		CustomerID:           metronome.F("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc"),
...
func TestCustomerInvoiceAddCharge(t *testing.T) {
	...
	_, err := client.Customers.Invoices.AddCharge(context.TODO(), metronome.CustomerInvoiceAddChargeParams{
		CustomerID:            metronome.F("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc"),
...
func TestCustomerInvoiceListBreakdownsWithOptionalParams(t *testing.T) {
	...
	_, err := client.Customers.Invoices.ListBreakdowns(context.TODO(), metronome.CustomerInvoiceListBreakdownsParams{
		CustomerID:           metronome.F("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc"),
		EndingBefore:         metronome.F(time.Now()),
		StartingOn:           metronome.F(time.Now()),
		CreditTypeID:         metronome.F("credit_type_id"),
